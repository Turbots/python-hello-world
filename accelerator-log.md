...
```json
{
  "functionName" : "hello",
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/Turbots/python-functions-accelerator.git",
  "includeTap" : true,
  "interfaceType" : "http",
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [my-python-fn->python-hello-world, main->hello]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/python-functions-accelerator.git->https://github.com/T...(truncated), my-python-fn->python-hello-world, main->main]
...
┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [my-python-fn->python-hello-world]
